...
- **Smart WMI Monitor Detection:** Automatically detects connected displays (e.g., *Acer KG241*, *LG TV*) and estimates active vs. standby power draw.
...
- **Supporter Code:** After donating, enter your supporter code to hide the donation button permanently and activate the Supporter badge.
